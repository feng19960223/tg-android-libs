 ...
 * 带清除按钮的EditText
 */
public class TgClearEditText extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    public TgClearEditText(Context context) {
        this(context, null);
    }

    public TgClearEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public TgClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.tg_common_ic_clear_24dp, null);
        }
