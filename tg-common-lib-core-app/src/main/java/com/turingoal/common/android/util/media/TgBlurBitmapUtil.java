...
public class TgBlurBitmapUtil {
    private static TgBlurBitmapUtil sInstance;
    private TgBlurBitmapUtil() {
    }
    public static TgBlurBitmapUtil instance() {
        if (sInstance == null) {
            synchronized (TgBlurBitmapUtil.class) {
                if (sInstance == null) {
                    sInstance = new TgBlurBitmapUtil();
                }
            }
        }
        return sInstance;
