 ...
 * </pre>
 */
public final class TgFlashlightUtil {

    private static final String TAG = "FlashlightUtils";

    private Camera mCamera;

    private TgFlashlightUtil() {
    }

    /**
     * Return the single {@link TgFlashlightUtil} instance.
     *
     * @return the single {@link TgFlashlightUtil} instance
     */
    public static TgFlashlightUtil getInstance() {
    ...
    private static final class LazyHolder {
        private static final TgFlashlightUtil INSTANCE = new TgFlashlightUtil();
    }
}
