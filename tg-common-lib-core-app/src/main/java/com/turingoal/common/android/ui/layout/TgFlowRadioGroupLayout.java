 ...
 */
public class TgFlowRadioGroupLayout extends LinearLayout {
    ...
    public TgFlowRadioGroupLayout(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public TgFlowRadioGroupLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new TgFlowRadioGroupLayout.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof TgFlowRadioGroupLayout.LayoutParams;
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == TgFlowRadioGroupLayout.this && child instanceof RadioButton) {
                int id = child.getId();
                // generates an id if it's missing
                if (id == View.NO_ID) {
                    id = child.hashCode();
            ...
            } else if (parent == TgFlowRadioGroupLayout.this
